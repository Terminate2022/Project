...
void RK4(){
    ...
    X5[i]=RK4Params::y0(4);
    X6[i]=RK4Params::y0(5);*/
    fstream dataFile("G://Qtprogram//exercise//RigidBodyDynamics2//dataFile.txt",ios::out);  //创建ofstream
    for(i=0; i < n+1; i++){
    dataFile <<i+1<<"*"<<X1[i]<<"  ";
}
    dataFile <<endl;
    ...
    dataFile <<i+1<<"*"<<X6[i]<<"  ";
     ...
     dataFile <<endl;
     dataFile <<endl;
    //<<X2<<endl<<X3<<endl<<X4<<endl<<X5<<endl;
}
...
void RK41(){
   ...
   //cout<< x0<<"\t"<<RK4Params1::y0(0)<<endl;//gai1
    for(i=0; i < n; i++)
    {
      ...
      /*initStatesParams::RotMatrS <<  X71[i]*X71[i]+X81[i]*X, -X81[i], -X91[i],-X101[i],
      ...
      RK4Params1::OmigaST << 0,X11[i],X12[i],X13[i];
       cout << RK4Params1::OmigaS<<endl<<RK4Params1::OmigaST<<endl;
     ...
     cout << RK4Params1::OmigaS<<endl<<RK4Params1::OmigaST<<endl;
      ...
      RK4Params1::OmigaST << 0,X11[i]+RK4Params2::k3(0),X12[i]+RK4Params2::k3(1),X13[i]+RK4Params2::k3(2);
      cout << RK4Params1::OmigaS<<endl<<RK4Params1::OmigaST<<endl;
      JXO << initStatesParams::JcS*RK4Params1::OmigaS ;
      RK4Params1::OCRJOS <<  RK4Params1::OmigaS(1)*JXO(2)-RK4Params1::OmigaS(2)*JXO(1),
                            -RK4Params1::OmigaS(0)*JXO(2)+RK4Params1::OmigaS(2)*JXO(0),
    ...
    X12[i]=RK4Params1::y0(5);
    X13[i]=RK4Params1::y0(6);
    //fstream dataFile2("G://Qtprogram//exercise//RigidBodyDynamics2//dataFile2.txt",ios::out);
    ofstream dataFile("G://Qtprogram//exercise//RigidBodyDynamics2//dataFile.txt",ios::app);
    for(i=0; i < n+1; i++){
    dataFile <<i+1<<"*"<<X7[i]<<"  ";
}
    dataFile <<endl;
